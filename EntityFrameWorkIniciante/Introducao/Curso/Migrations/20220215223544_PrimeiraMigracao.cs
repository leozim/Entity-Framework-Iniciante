...
namespace CursoEFCore.Migrations
{
    public partial class PrimeiraMigracao : Migration
    {
        ...
        {
            // migrationBuilder.Sql("CREATE FUNCTION ..."); // executa uma instrução SQL no banco
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CEP = table.Column<string>(type: "CHAR(11)", nullable: false),
        ...
        {
            // migrationBuilder.Sql("DROP FUNCTION ..."); // necessario inserir uma instrução SQL que desfaz o q foi feito no método Up
